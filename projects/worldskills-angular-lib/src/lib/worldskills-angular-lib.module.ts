...
import { RecipientAwardCertificateFormComponent } from "./awards/components/recipient-award-certificate-form/recipient-award-certificate-form.component";
import { CommonModule } from "@angular/common";
import { WSTranslate } from "./i18n/ws-translate-pipe";

export const translateConfig = TranslateModule.forChild({
  loader: provideTranslateHttpLoader({
    prefix: "/assets/i18n/lazy-loaded/",
    suffix: ".json",
    enforceLoading: true,
    useHttpBackend: true,
  }),
