...
export declare class SelectComponent implements ControlValueAccessor, OnChanges, OnInit {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<SelectComponent, "ng-select", never, { "options": "options"; "allowClear": "allowClear"; "disabled": "disabled"; "multiple": "multiple"; "noFilter": "noFilter"; "notFoundMsg": "notFoundMsg"; "placeholder": "placeholder"; "filterPlaceholder": "filterPlaceholder"; "label": "label"; "highlightColor": "highlightColor"; "highlightTextColor": "highlightTextColor"; }, { "opened": "opened"; "closed": "closed"; "selected": "selected"; "deselected": "deselected"; "focus": "focus"; "blur": "blur"; "noOptionsFound": "noOptionsFound"; "filterInputChanged": "filterInputChanged"; }, ["optionTemplate"], never>;
}
