...
When **creating or updating** a component, read [COMPONENTS.md](COMPONENTS.md) first. It lists every existing component, service, and selector — and guides you to reuse or extend before creating something new.
